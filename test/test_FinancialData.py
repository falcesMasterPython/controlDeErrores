...
class FinancialDataTest(unittest.TestCase):
    ...
    def test_checkTwelveColumnsInDataFrame(self):
        ...
        self.assertTrue(self.financialData.checkTwelveColumnsInDataFrame())

        self.financialData.setDataFrame(self.dataFrame2)
        self.assertFalse(self.financialData.checkTwelveColumnsInDataFrame())

    def test_checkAllMonthsHaveData(self):
        self.financialData = FinancialData()

        self.financialData.setDataFrame(self.dataFrame1)
        self.assertTrue(self.financialData.checkAllMonthsHaveData())

        self.financialData.setDataFrame(self.dataFrame3)
        self.assertFalse(self.financialData.checkAllMonthsHaveData())
